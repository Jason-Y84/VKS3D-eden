...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceProperties");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceProperties2");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceFeatures");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceFeatures2");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceMemoryProperties");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceMemoryProperties2");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceQueueFamilyProperties");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceQueueFamilyProperties2");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceFormatProperties");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceFormatProperties2");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceImageFormatProperties");
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceSparseImageFormatProperties");
    LOOKUP_PD(pd);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_EnumerateDeviceExtensionProperties");
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_EnumerateDeviceLayerProperties");
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
...
stereo_GetPhysicalDeviceSurfaceSupportKHR(
    ...
    VkBool32        *pSupported)
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceSurfaceSupportKHR");
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfaceSupportKHR: pd=%p surface=%p", (void*)pd, (void*)(uintptr_t)surface);
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfaceSupportKHR: _real=%p _si=%p real_inst=%p",
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceSurfaceCapabilitiesKHR");
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfaceCapabilitiesKHR: pd=%p surface=%p", (void*)pd, (void*)(uintptr_t)surface);
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfaceCapabilitiesKHR: _real=%p real_inst=%p",
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceSurfaceFormatsKHR");
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfaceFormatsKHR: pd=%p surface=%p", (void*)pd, (void*)(uintptr_t)surface);
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceSurfacePresentModesKHR");
    STEREO_LOG_VERBOSE("stereo_GetPhysicalDeviceSurfacePresentModesKHR: pd=%p surface=%p", (void*)pd, (void*)(uintptr_t)surface);
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
...
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceToolProperties");
    LOOKUP_PD_R(pd, VK_ERROR_INITIALIZATION_FAILED);
...
stereo_GetPhysicalDeviceToolPropertiesEXT(
    ...
    VkPhysicalDeviceToolProperties     *pProperties)
{
    STEREO_LOG_VERBOSE("CALLED stereo_GetPhysicalDeviceToolPropertiesEXT");
